...
Panoramica also has an API endpoint for receiving activities from any source. Check out the [Import Data via API](/docs/developer-guides/import-data) guide to learn more.
