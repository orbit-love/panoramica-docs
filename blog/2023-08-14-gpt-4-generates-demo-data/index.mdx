...
<div className="padding-left--sm monospace">
  <p>
    Dave: Copying the program won't do anything, we need to reboot the
    multi-byte sms microchip
  </p>
  <p>Sally: We need to connect the bluetooth ADP port!</p>
  <p>
    Dave: The SMS application is down, copy the bluetooth microchip so we can
    hack the CSS program!
  </p>
  <p>
    Damo: Bypassing the card won't do anything, we need to generate the mobile
    json monitor!
  </p>
</div>
